...
export async function deleteStudentScore(gradeItemID:string,studentID:string):Promise<void>{await request(`/api/v1/grade-items/${gradeItemID}/scores/${studentID}`,{method:'DELETE'})}
