...
export default function TeacherLessonsView({assignment,quarters=[],className,onBack}:{assignment:ClassSubjectRecord;quarters?:{id:string;number:number;name?:string;startsOn?:string;endsOn?:string}[];className?:string;onBack:()=>void}){
